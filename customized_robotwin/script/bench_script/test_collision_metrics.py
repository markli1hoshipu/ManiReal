...
USAGE:
    ...
    source set_env.sh
    python script/bench_script/test_collision_metrics.py <task_name> <task_config> [options]
...
def main():
    ...
    # Save collision log
    log_path = output_dir / "collision_log.json"
    ...
    metrics_path = output_dir / "collision_metrics.json"
    ...
    # Save video
    video_path = output_dir / "collision_test.mp4"
    if frame_list:
        try:
            import imageio
            fps = 30
